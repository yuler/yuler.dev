...
```bash
gwa ui-1 && opencode --yolo .

使用这个 https://www.ui-skills.com/ UI skill 来优化下网站样式, Skill 只安装到本地, 项目级别安装
黑白风格, 完成后打开浏览器预览下

gwa ui-2 && claude . --dangerously-skip-permissions
使用这个 https://impeccable.style/ UI skill 来优化下网站样式, Skill 只安装到本地, 项目级别安装
极客风格, 完成后打开浏览器预览下

gwa ui-3 && codex
使用这个 https://github.com/Leonxlnx/taste-skill UI skill 来优化下网站样式, Skill 只安装到本地, 项目级别安装
大字报风格, 完成后打开浏览器预览下
```
